Feature: As a content owner I want to be able to upload different file types to link to from any pages
    ...
    Scenario: Clean up related resources and mini landing page test content
        ...
        And user clicks on "Media" sub tab
        And user deletes test file and translation with url "test-file-pdf"
        And user deletes test file and translation with url "test-file-csv"
        And user deletes test file and translation with url "test-file-pptx"
        And user deletes test file and translation with url "test-file-ppt"
        And user deletes test file and translation with url "test-file-xlsx"
        And user deletes test file and translation with url "test-file-xls"
        And user deletes test file and translation with url "test-file-docx"
        And user deletes test file and translation with url "test-file-doc"