Feature: As a cms user I want to be able to create Article content type to promote Article
    ...
    Scenario: Add a translation
        ...
        Then page title is "Create Spanish translation of Automated Test Article Edited"
        ...
        And heading was translated as "Heading"
        And body content was translated as "Content"
        And Add Body Section was translated as "Add Body Section"
        ...
        And "Public Use Text" dropdown displays "Display"
    ...
    Scenario: Edit and republish Spansih article content type
        ...
        And user fills out the following fields
            | fieldLabel       | value                                                  | field_name             |
            | Page Title       | Automated Test Article Edited Spanish                  | title                  |
