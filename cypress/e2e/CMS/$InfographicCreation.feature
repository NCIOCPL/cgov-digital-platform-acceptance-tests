Feature: As a cms user I want to be able to create an Infographic media content type to promote Infographic media content type
    ...
    When user saves the content page
        ...
        And user selects "Add NCIDS 3 Feature Card Row" from "Contents" dropdown in home and landing page
        And browser waits
        And user fills out the following fields
            | fieldLabel | value              | field_name                                                            |
            | Heading    | 3 Feature Card Row | field_landing_contents[0][subform][field_container_heading][0][value] |
    ...
    Scenario: Verify Infographic at the front end in the English Home and Landing page
        ...
        And NCIDS feature cards have the following attributes
            ...
            | 1     | Automated Test Infographic - Card Title | Automated Test Infographic - Featured Card Desc | {TEST_SITE_SECTION}/test-infographic | /sites/default/files/styles/ncids_featured_16x9/public/cgov_image/ncids_promo_art_16x9 | promo-placeholder | N/A            |
