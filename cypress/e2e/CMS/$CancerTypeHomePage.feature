...
#             | Pretty URL               | mini-landing-page-test-cancer-type-home-page        | field_pretty_url               |
...
#         And the tool bar appears at the top
#         When user clicks on "Content" tab
#         And user clicks on the title with url "mini-landing-page-test-cancer-type-home-page" from the list of content
#         And user clicks on the tool bar status button "Published"
#         And user clicks "View in edit form" button from other actions
...
#         Given user is navigating to the front end site with path site section plus "mini-landing-page-test-cancer-type-home-page"
...
#         And user selects a checkbox next to title with url "mini-landing-page-test-cancer-type-home-page" from the list of content
#         And user clicks on "Apply to selected items" content action button
#         Then page title is "Are you sure you want to delete this content item?"
#         When user clicks on "Delete" button
#         Then the confirmation text "Deleted 1 content item" appears on a screen
#         And the content item with url "mini-landing-page-test-cancer-type-home-page" does not exist in the list of content