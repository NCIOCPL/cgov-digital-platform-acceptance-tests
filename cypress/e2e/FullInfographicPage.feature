Feature: As I user I want to be able to see full infographic page
    ...
    Scenario: Full infographic page with translation without mobile image english
        ...
        And there should be an infographic with the following
            ...
            | caption      | none                                                                                                 |
            | mobileImage  | none                                                                                                 |
            | desktopImage | .*\/files\/styles\/cgov_article\/public\/cgov_infographic\/\d{4}-\d{2}\/nci-at-a-glance-enlarge\.gif |
        And "View and Print Infographic" link appears below caption text with the href ".*\/files\/styles\/cgov_enlarged\/public\/cgov_infographic\/\d{4}-\d{2}\/nci-at-a-glance-enlarge\.gif"
    ...
    Scenario: Full infographic page with translation without mobile image spanish
        ...
        And there should be an infographic with the following
            ...
            | alt          | empty                                                                                                            |
            | mobileImage  | none                                                                                                             |
            | desktopImage | .*\/files\/styles\/cgov_article\/public\/cgov_infographic\/\d{4}-\d{2}\/espanol-nci-at-a-glance-infographic\.gif |
        And "Ver e Imprimir Infografía" link appears below caption text with the href ".*\/files\/styles\/cgov_enlarged\/public\/cgov_infographic\/\d{4}-\d{2}\/espanol-nci-at-a-glance-infographic\.gif"
    ...
    Scenario: Full infographic page without translation without mobile image
        ...
        And there should be an infographic with the following
            ...
            | alt          | empty                                                                                                                             |
            | mobileImage  | none                                                                                                                              |
            | desktopImage | .*\/files\/styles\/cgov_article\/public\/cgov_infographic\/\d{4}-\d{2}\/cancer-and-the-human-tumor-atlas-network-infographic\.png |
        And "View and Print Infographic" link appears below caption text with the href ".*\/files\/styles\/cgov_enlarged\/public\/cgov_infographic\/\d{4}-\d{2}\/cancer-and-the-human-tumor-atlas-network-infographic\.png"
    ...
    Scenario: Full translated infographic page with mobile image english - Tablet
        ...
        And there should be an infographic with the following
            ...
            | mobileImage  | .*\/files\/styles\/cgov_article\/public\/\d{4}-\d{2}\/Pediatric-MATCH-enlarge\.png                          |
            | desktopImage | .*\/files\/styles\/cgov_article\/public\/cgov_infographic\/\d{4}-\d{2}\/Human-Tumor-Atlas-AP-web-640x2\.png |
        And "View and Print Infographic" link appears below caption text with the href ".*\/files\/styles\/cgov_enlarged\/public\/cgov_infographic\/\d{4}-\d{2}\/Human-Tumor-Atlas-AP-web-640x2\.png"
    ...
    Scenario: Full translated infographic page with mobile image spanish
        ...
        And there should be an infographic with the following
            ...
            | mobileImage  | .*\/files\/styles\/cgov_article\/public\/\d{4}-\d{2}\/pediatric-match-espanol-enlarge\.png                          |
            | desktopImage | .*\/files\/styles\/cgov_article\/public\/cgov_infographic\/\d{4}-\d{2}\/Human-Tumor-Atlas-AP-web-spanish-640x2\.png |
        And "Ver e Imprimir Infografía" link appears below caption text with the href ".*\/files\/styles\/cgov_enlarged\/public\/cgov_infographic\/\d{4}-\d{2}\/Human-Tumor-Atlas-AP-web-spanish-640x2\.png"
