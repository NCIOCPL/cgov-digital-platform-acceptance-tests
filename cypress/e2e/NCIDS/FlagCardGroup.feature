Feature: As a user I want to be able to add a NCIDS flag card group component onto a page
    ...
    Scenario Outline: Flag card group components
        ...
        Then NCIDS flag cards have the following attributes
            ...
            | 0     | About Cancer            | This flag card is an internal link to About Cancer                                                                                                                                           | /about-cancer                           | No Image Placeholder | /sites/default/files/styles/ncids_promo_1x1/module/cgov_image                     | placeholder-1x1.png          |
            ...
            | 3     | Cancer Types            | none                                                                                                                                                                                         | /types                                  | No Image Placeholder | /sites/default/files/styles/ncids_promo_1x1/module/cgov_image                     | placeholder-1x1.png          |
            | 4     | Cancer Research         | This is another card that should be on its own line when cards appear in the side-by-side orientation.                                                                                       | /research                               | No Image Placeholder | /sites/default/files/styles/ncids_promo_1x1/module/cgov_image                     | placeholder-1x1.png          |
