Feature: As a user I want to be able to add a NCIDS guide card component onto a page
    ...
    Scenario: 3 Guide card row components
        ...
        Then NCIDS 3 guide card row at position 1 have the following attributes
            ...
            | 1     | Grant Process          | Learn More\|https://www.google.com;Learn More 1\|https://www.google.com;[Internal Promo Block] Card Title\|/test/internal-promo-block-test-article                                                                                                                                                                                                                                                                                                                                                                    |
    ...
    Scenario: Guide card external button click event
        ...
        When user clicks on "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean m" button on a 1 NCIDS guide card
