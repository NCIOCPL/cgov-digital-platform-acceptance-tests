Feature: As a content editor, I would like to be able to embed a borderless full-width card, so that we can promote the most important information effectively.
    ...
    Scenario Outline: Content editor added an article content item with lead image
        ...
        Examples:
            ...
            | desktop          | /test/borderless-card | 1          | [Lead IMG Crops] Card Title | /test/lead-img-crops | [Lead IMG Crops] Card Description | ARTICLE WITH LEAD | .*\/files\/styles\/cgov_borderless_card\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_zedd_happy\.jpg.* | Zedd vs the Octopus |
            | custom 640x900   | /test/borderless-card | 1          | [Lead IMG Crops] Card Title | /test/lead-img-crops | [Lead IMG Crops] Card Description | ARTICLE WITH LEAD | .*\/files\/styles\/cgov_borderless_card\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_zedd_happy\.jpg.* | Zedd vs the Octopus |
            | mobile           | /test/borderless-card | 1          | [Lead IMG Crops] Card Title | /test/lead-img-crops | [Lead IMG Crops] Card Description | ARTICLE WITH LEAD | .*\/files\/styles\/cgov_borderless_card\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_zedd_happy\.jpg.* | Zedd vs the Octopus |
    ...
    Scenario Outline: Content editor added an article with override title
        ...
        Examples:
            | screenBreakpoint | url                   | cardNumber | cardTitle       | titleHref            | cardDescription                   | buttonText         | promoImageSource                                                                                             | promoImageAlt       |
            | desktop          | /test/borderless-card | 5          | Alternate Title | /test/lead-img-crops | [Lead IMG Crops] Card Description | ARTICLE WITH TITLE | .*\/files\/styles\/cgov_borderless_card\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_zedd_happy\.jpg.* | Zedd vs the Octopus |
            | custom 640x900   | /test/borderless-card | 5          | Alternate Title | /test/lead-img-crops | [Lead IMG Crops] Card Description | ARTICLE WITH TITLE | .*\/files\/styles\/cgov_borderless_card\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_zedd_happy\.jpg.* | Zedd vs the Octopus |
            | mobile           | /test/borderless-card | 5          | Alternate Title | /test/lead-img-crops | [Lead IMG Crops] Card Description | ARTICLE WITH TITLE | .*\/files\/styles\/cgov_borderless_card\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_zedd_happy\.jpg.* | Zedd vs the Octopus |
