Feature: As a content editor, I would like to be able to embed an alternating image list, so that we can engage the user more visually.
    ...
    Scenario Outline: Content editor added a list item with an override promo image with internal links
        ...
        Examples:
            ...
            | /special-report         | 1              | .*\/files\/styles\/cgov_panoramic\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_smoo_article\.jpg*                 | Cat-Cat                                      | /news-events/press-releases/2019/deep-learning-cervical-cancer-screening |
            | /espanol/special-report | 2              | .*\/files\/styles\/cgov_panoramic\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/nci-shady-grove-building-article\.jpg* | National Cancer Institute Shady Grove Campus | /news-events/press-releases/2019/brca-exchange                           |
    ...
    Scenario Outline: Content editor added a list item with an article image with internal links
        ...
        Examples:
            ...
            | desktop          | /special-report | 3              | .*\/files\/styles\/cgov_panoramic\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/BRCA-exchange-article\.jpg* | The BRCA Exhange graphic | /news-events/press-releases/2019/brca-exchange |
            | tablet           | /special-report | 3              | .*\/files\/styles\/cgov_panoramic\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/BRCA-exchange-article\.jpg* | The BRCA Exhange graphic | /news-events/press-releases/2019/brca-exchange |
    ...
    Scenario Outline: Content editor added a list item with an external link
        ...
        Examples:
            ...
            | 5              | .*\/files\/styles\/cgov_panoramic\/public\/cgov_image\/media_image\/\d{4}-\d{2}\/pet_smoo_article\.jpg* | Cat-Cat       | https://www.google.com |
